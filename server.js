...
- Knowledge-save requests and timeless operational definitions are not sales analyses: never request a date range, choose a currency, or add a date/currency scope to them.
- Hypothetical policy or definition questions are timeless unless the user explicitly makes them historical. Never request dates or default a currency for them. Retrieve and apply the relevant governed definition. For the made-to-order stock rule, retrieve definition df_1343decb-ea0a-483a-9dbe-b579c328cb4f: positive Online stock can be ready to ship; zero stock is made to order only when the product has the made-to-order tag. Without that tag, zero stock does not establish made-to-order availability. Answer the stock-policy question directly and omit unrelated cohort, order-sequence, classification-coverage, and resolved-scope boilerplate.
