...
export function assertFamilyAssignment(sourceRef,parentRef,history=[],{replacingDecisionId=null}={}) {
  ...
  if(sourceRef.startsWith('shopify:')||!parentRef.startsWith('shopify:shopify:'))throw new Error('family membership requires a non-Shopify source product and Shopify parent');
