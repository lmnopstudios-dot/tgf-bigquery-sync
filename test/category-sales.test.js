...
import {CATEGORY_SALES_TOOL_DEFINITION,categorySalesSql,createCategorySalesService,executeCategorySalesToolCall} from '../oracle/category-sales.js';
...
test('service is bounded, aggregate, currency-safe and exposes classification/refund semantics',async()=>{
  let call;const service=createCategorySalesService({project:'p',bigquery:{query:async value=>{call=value;return [[{source_platform:'shopify',currency:'GBP',sales_category:'sunglasses',sales:12}]]}}});
