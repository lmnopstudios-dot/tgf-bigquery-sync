...
import { createProposalGenerator, needsProposalGeneration, proposalDiagnostic } from '../oracle/proposals.js';
...
try { await validate(); }
  ...
  console.error(JSON.stringify(proposalDiagnostic(error, model)));
  process.exitCode = 1;
}
